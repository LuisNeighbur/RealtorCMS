...
<div id="form">
	<div class="form-signin" role="form">
	    ...
	    <input id="pass" name="pass" type="password" class="form-control" style="margin-bottom: 0px;" placeholder="Contraseña">
		<input id="repass" name="pass" type="password" class="form-control" placeholder="Repetir Contraseña">
